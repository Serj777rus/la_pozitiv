...
created() {
    ...
    // const posts = this.$route.query.posts;
    // console.log('Mounted with posts:', posts);
    if (this.posts) {
      try {
        this.post = JSON.parse(decodeURIComponent(this.posts)); // Десериализуем строку JSON в объект
